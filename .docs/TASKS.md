...
- [ ] **Recent repos empty-after-removal pull guard** — Add a focused regression test that removing the final recent repo after rerenders leaves Pull targeting only the current active repo state and never a stale removed entry.
