...
- [ ] **Browser smoke script self-check** — Add a lightweight helper or test that verifies the extracted smoke files can still be assembled/executed together after future refactors.
