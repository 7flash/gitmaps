...
- [ ] **Initial route error helper split** — Consider extracting the remaining initial-route error/loading UI callbacks (clone-start messaging + toast fallback) so `page.client.tsx` keeps shrinking and route hydration stays directly testable.
