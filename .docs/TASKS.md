...
- [ ] **Repo-load + transclusion smoke test** — Add a reproducible browser/DOM smoke path that proves slug-route hydration, repo load, transclusion generation, and click-to-source interaction keep working together.
