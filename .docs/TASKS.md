...
- [ ] **Initial route hydration helper extraction** — Consider moving more of the first-load slug resolution/bootstrap path out of `page.client.tsx` so initial route entry can be regression-tested without importing the full client orchestrator.
