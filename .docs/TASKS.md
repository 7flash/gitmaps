...
- [ ] **Mount init helper split** — Consider moving the remaining DOM/module boot sequence from `page.client.tsx` into a tiny init helper so mount becomes almost entirely composition + cleanup.
