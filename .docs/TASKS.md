...
- [ ] **Browser-tools repo-load/self-check unification** — Consider sharing more assembly/template helpers between repo-load smoke and repo-switch smoke so the two browser-tools paths drift less over time.
