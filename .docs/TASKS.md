...
- [ ] **Transclusion UX/threshold tuning** — Reduce noisy prefix matches, improve placement for dense canvases, and make virtual cards feel more explanatory than decorative.
- [ ] **Transclusion interactions** — Add click/hover affordances to jump between a virtual card and its source file/lines, with better connection rendering during pan/zoom.
