...
- [ ] **Repo-load handoff coverage for route hydration** — Add a focused regression test around slug/popstate-driven repo entry so route bootstrap can reuse the same handoff seam without importing the full page client.
