...
- [ ] **Mount cleanup helper split** — Consider extracting the remaining cleanup body (actor stop, preview teardown, canvas clear) into a tiny helper so `page.client.tsx` becomes almost pure composition.
