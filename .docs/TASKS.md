...
- [ ] **Fresh-session slug route fails for already-known repos** — Direct `/owner/repo` navigation in a clean browser profile can still fall into clone logic and fail instead of reusing/resolving an existing local repo.
