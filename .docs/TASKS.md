...
- [ ] **Routing fixture sharing upstream** — Consider moving the reusable routing contract fixture/helpers into Melina examples or test utilities so other apps can verify catch-all routing without copy-pasting fixture code.
