...
- [ ] **Mount route wiring helper split** — Consider extracting the remaining route-hydration + popstate wiring from `page.client.tsx` into a tiny composition helper so mount becomes almost entirely shell setup/cleanup.
