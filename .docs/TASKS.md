...
- [ ] **Initial route helper consolidation polish** — Consider collapsing the remaining `hideLanding`/hash-migration callback glue into tiny exported helpers so `page.client.tsx` contains only composition, not route-specific DOM details.
