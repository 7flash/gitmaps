...
- [ ] **Shared layout helper extraction** — Consider moving the remaining inline shared-layout decode/apply path out of `page.client.tsx` so the mount orchestrator is almost purely composition.
