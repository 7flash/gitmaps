...
- [ ] **Browser smoke helper flow** — Add one repeatable browser-tools script or helper path that opens the app, loads a known repo, and verifies canvas bootstrap without manual clicking.
