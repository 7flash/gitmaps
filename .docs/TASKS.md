...
- [ ] **Browser-tools smoke helper extraction** — Split the large shell smoke script into smaller reusable helpers/files so the browser-tools path stays maintainable as more checks are added.
